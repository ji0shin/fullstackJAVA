...
public class Ex10메서드들 {
	...
	public static void main(String[] args) {
		...
		// String과 관련된 Method 모음
		// indexOf()
		// 특정 문자열 또는 특정 문자의 위치를 반환
		String data = "여러분 안녕?";
		// "안"
		...
		String data3 = "hello.txt";
		if(data3.endsWith(".txt") == true){
		    System.out.println("확장자가 맞습니다!");
		}
		
		String data4 = "여러분 안녕?";
		System.out.println(data4.replace("여러분", "임마"));
		System.out.println(data4);
		
		
		String data5 = "Hello, World!!";
		String trans = data5.toUpperCase();
